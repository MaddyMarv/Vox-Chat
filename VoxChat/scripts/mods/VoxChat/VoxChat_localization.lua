local loc = {
    ...
    show_self_description = {
        en = "Show the voice popup when you speak.",
    },
    mission_only = {
        en = "Mission Only",
    },
    ...
    hud_offset_y_description = {
        en = "Adjust the vertical position of the voice popup (0 = Top of screen).",
    },
    alignment = {
        en = "Alignment",
    },
    alignment_description = {
        en = "Choose which side of the screen the voice popup appears on.",
    },
    left = {
        en = "Left",
    },
